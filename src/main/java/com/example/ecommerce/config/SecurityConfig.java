	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http
				...
				.authorizeHttpRequests(auth -> auth
						...
						.requestMatchers(HttpMethod.GET, "/api/warehouses/**").hasAnyRole("ADMIN", "WAREHOUSE_STAFF")
						...
						.requestMatchers("/api/orders/**").hasAnyRole("ADMIN", "CUSTOMER", "WAREHOUSE_STAFF")
						.requestMatchers(HttpMethod.POST, "/api/returns/**").hasRole("CUSTOMER")
						.requestMatchers(HttpMethod.GET, "/api/returns/**").hasAnyRole("CUSTOMER", "ADMIN", "WAREHOUSE_STAFF")
